package com.liulei.mall.wechat.mp.handler;

import com.liulei.mall.basics.common.utils.RedisUtil;
import com.liulei.mall.basics.common.utils.RegexUtils;
import com.liulei.mall.wechat.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
	/** 用户发送手机验证码提示*/
	@Value("${liulei.wechat.registration.code.message}")
	private String registrationCodeMessage;
	/** 默认用户发送验证码提示 */
	@Value("${liulei.wechat.registration.code.defaultMessage}")
